...
export const THEMES = {
  sand: {
    ...
    depthBadge: {
      ...
      3: 'bg-stone-400 text-white',
      4: 'bg-stone-300 text-stone-700',
      5: 'bg-stone-200 text-stone-600'
    },
    fontMono: false
  },
  ...
  dark: {
    ...
    depthBadge: {
      ...
      3: 'bg-[#3a3d41] text-[#cccccc]',
      4: 'bg-[#2d2d30] text-[#858585]',
      5: 'bg-[#252526] text-[#6e6e6e]'
    },
    fontMono: true
  },
  ...
  light: {
    ...
    depthBadge: {
      ...
      2: 'bg-[#616161] text-white',
      3: 'bg-[#9e9e9e] text-white',
      4: 'bg-[#d4d4d4] text-[#616161]',
      5: 'bg-[#e5e5e5] text-[#9e9e9e]'
    },
    fontMono: true
  }
};
...
// Max tree depth (levels of nesting)
